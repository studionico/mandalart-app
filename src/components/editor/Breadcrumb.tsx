...
function MiniPreview({ cells, highlightPosition }: { cells: BreadcrumbItem['cells']; highlightPosition: number | null }) {
...
export default function Breadcrumb() {
  ...
  const { breadcrumb, popBreadcrumbTo, mandalartId } = useEditorStore()
