 ...
 *
 * 220ms はドリルまでの "間" として体感しやすかったため、120ms に短縮して
 * クリック直後にドリルアニメが始まる感覚を優先する。ダブルクリック判定としては
 * 十分早い (人の意図的な double click は 100ms 以上空くのが通常)。
 */
export const CLICK_DELAY_MS = 120
