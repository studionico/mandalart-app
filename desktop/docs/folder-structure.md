...
│   ├── ios-ci.yml            # iOS: LogicTests を macOS runner で実行 (ios/** 変更時)
...
| `.github/workflows/ios-ci.yml` | `ios/**` 変更時に macOS runner で iOS の `LogicTests` (Supabase 非リンク) を `xcodebuild test` |
