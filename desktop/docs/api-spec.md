...
// メモ / context menu import / D&D の move・shred・stock 貼付け) を block する。閲覧
// (drill / 9×9 / parallel switch / breadcrumb / copy / export) と マンダラート
...
// ストック追加 (addToStock / moveCellToStock) で使用する。
...
// 周辺セルなのに中心セルが空ならエラー。pasteFromStock の本体として使う。
...
// ストックの置換 (pasteFromStockReplacing) の本体として使う。
